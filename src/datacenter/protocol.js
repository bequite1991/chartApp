const PROTOCAL_REQUEST = {
  ...
  '9008':'/inshn_dtimao/huibao/req/mai_dev_num', // 每月维保审核数目接口
  '9009':'/inshn_dtimao/huibao/req/mai_user_info', // 维保人员信息接口
  '9010':'/inshn_dtimao/huibao/req/mai_dev_info', // 维保记录查询接口
};
