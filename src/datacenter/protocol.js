const PROTOCAL_REQUEST = {
  ...
  '9004': 'inshn_dtimao/huibao/req/dev_alarm_repeat/user', // 故障接警未处理接口
  ...
  '9008': 'inshn_dtimao/huibao/req/dev_alarm_norepeat/user', // 故障取消处理接口;
  ...
  '9013': 'inshn_dtimao/huibao/req/use_corp_dev_cnt/user', // 小区安装记录接口
};
...
const PROTOCAL_RESPONSE = {
  ...
  '9004': 'inshn_dtimao/huibao/resp/dev_alarm_repeat/user', // 故障接警未处理接口
  ...
  '9008': 'inshn_dtimao/huibao/resp/dev_alarm_norepeat/user', // 故障取消处理接口;
  ...
  '9013': 'inshn_dtimao/huibao/resp/use_corp_dev_cnt/user', // 小区安装记录接口
};
